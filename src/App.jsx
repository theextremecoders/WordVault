      ...
      <footer className="border-t border-base-300 bg-base-200/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-3 max-w-6xl">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-3">
              <span className="hidden lg:block text-xs text-base-content/45 italic">“We build the things clients dream of.”</span>
              <button
          ...
          <p className="mt-2 text-center text-xs text-base-content/35">
            WordVault — Powered by <a href="https://dictionaryapi.dev" target="_blank" rel="noopener noreferrer" className="link link-primary opacity-60">Free Dictionary API</a> · Built with React, Vite &amp; DaisyUI
          </p>
        </div>
      </footer>
          ...
          <div className="fixed inset-0 z-[101] flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-primary/20 via-secondary/10 to-base-200 p-8 pb-6 rounded-t-2xl">
                ...
                <p className="text-xl font-bold mb-1.5">We build products people love — fast.</p>
